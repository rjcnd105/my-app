...
export function TextInput({ className, placeholder, ...props }: TextInput.Props) {
  return <BaseTextInput classNames={{
    ...
    wrapper: "TextInput__wrapper group h-12 py-2 [&_input:placeholder-shown~div>button[data-part=close]]:invisible flex items-center justify-center",
...
function InputClearButton() {
  ...
  return <Button data-part="close" className="px-2 w-7.5 h-full" >
    <Icon name="cross_circle" className="size-full fill-gray100" ></Icon>
  </Button>
}
