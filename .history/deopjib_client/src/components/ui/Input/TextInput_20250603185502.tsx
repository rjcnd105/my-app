...
function InputClearButton() {
  return <Button className="focus-visible:[&_svg]:ring-1 ring-blue300  group-has-placeholder-shown:invisible px-2 w-7.5 h-full" onClick={inputClear} >
    <Icon name="cross_circle" className="size-3.5 rounded-full fill-gray100" ></Icon>
  </Button>
}
