defmodule Dutchpay.Accounts.User do
  use Ecto.Schema
  ...
  defp maybe_validate_unique_email(changeset, opts) do
    if Keyword.get(opts, :validate_email, true) do
      changeset
      |> unsafe_validate_unique(:email, Dutchpay.Repo)
  ...
  """
  def valid_password?(%Dutchpay.Accounts.User{hashed_password: hashed_password}, password)
