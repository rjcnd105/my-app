  ...
  return (
    <div className="[&_h3]:text-title [&_h3]:mt-2 [&_h3]:mb-1 px-4">
      ...
      <Wrapper className="bg-gray100">
        {joinMap([objKeys(Button.themes), objKeys(Button.sizes)], (theme, size) => (
      ...
      <h3>modal</h3>
      <Wrapper>
        <Button className="text-caption2" onClick={() => stack.open("confirmModal")}>
          confirmModal
        </Button>
...
function Wrapper({
  ...
  return <div className={cn("flex flex-wrap gap-4 p-2", className)}>{children}</div>;
}
